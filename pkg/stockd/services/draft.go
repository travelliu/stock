...
func (s *Service) UpsertDraft(ctx context.Context, in UpsertInput) (*models.IntradayDraft, error) {
...
func (s *Service) GetDraftByDate(ctx context.Context, userID uint, tsCode, tradeDate string) (*models.IntradayDraft, error) {
	var row models.IntradayDraft
	err := s.db.WithContext(ctx).
...
func (s *Service) DeleteDraft(ctx context.Context, userID, id uint) error {
